      ...
      value: () => {
        ...
        targets.forEach(target => {
          ...
          target.ondrop = e => {
            ...
            // *** Added if statement to check for child nodes
            // *** Added ablitiy to put cards back into middle section within if statement

            if (e.target.hasChildNodes() === false || e.target.classList.contains("origin")) {
